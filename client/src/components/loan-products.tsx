    ...
    <section id="loans" className="py-16 bg-white">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-12">
          <h2 className="text-3xl lg:text-4xl font-bold text-gray-900 mb-4">Professional Financing Solutions</h2>
          <p className="text-lg text-gray-600 max-w-2xl mx-auto">Specialized property financing for investors with integrity and professional service - we have many more options available</p>
        </div>
